                    ...
                    <div className=" w-full h-1/4 flex ">
                        ...
                        {riceAccessions.map((rice) => (
                            <div className=" flex flex-col flex-auto p-3 pt-0">
                                ...
                                <h1 className="text-xl text-sprGray60 font-medium">Source: {rice.source === '' ? "---" : rice.source}</h1>
                                <h1 className="text-xl text-sprGray60 font-medium">Variety: {rice.variety === '' ? "---" : rice.variety}</h1>
                                <h1 className="text-xl text-sprGray60 font-medium">{rice.classification}</h1>
